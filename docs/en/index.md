...
description: 'Send a Chart.js configuration as JSON and get a rendered PNG back, no browser required. Chart.js plus 12 plugins in one binary, with an HTTP API and a CLI.'
---
