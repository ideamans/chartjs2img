...
| チュートリアル                            | 向いている場面                                                                    |
| ----------------------------------------- | --------------------------------------------------------------------------------- |
| [Claude Code プラグイン](./claude-plugin) | Claude Code を使っている。スラッシュコマンド (`/chartjs2img-install`, `/chartjs2img-llm`, `/chartjs2img-author`, `/chartjs2img-render`) でワークフロー全体を駆動。 |
...
- **[`chartjs2img llm`](./cli#chartjs2img-llm)** — Chart.js config JSON の形状、同梱プラグインの全オプション、標準例をワンショット Markdown で吐き出す。
...
- **[`plugins/chartjs2img`](https://github.com/ideamans/chartjs2img/tree/main/plugins/chartjs2img)** — Claude Code と `gh skill` で配布される 4 スキル (`chartjs2img-install`, `chartjs2img-render`, `chartjs2img-author`, `chartjs2img-llm`)。
