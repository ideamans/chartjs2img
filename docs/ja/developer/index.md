---
title: 開発者ガイド
description: 'リポジトリをクローンして chartjs2img を読み解き・拡張したい時の道標。変更の種類ごとに、どこを見ればいいかをまとめました。2 つのエンジンで Chart.js を描画する薄いラッパーです。'
---
...
<!-- 図の元データ: docs/diagrams/architecture-overview.gg（`bun run docs:diagrams` で再生成） -->
